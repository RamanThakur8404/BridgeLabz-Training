...
public class FileCopyPerformance {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String source = "src/com/streams/bufferedstreams/source_100MB.bin";
        String unbufferedDest = "src/com/streams/bufferedstreams/unbuffered_copy.bin";
        String bufferedDest = "src/com/streams/bufferedstreams/buffered_copy.bin";
