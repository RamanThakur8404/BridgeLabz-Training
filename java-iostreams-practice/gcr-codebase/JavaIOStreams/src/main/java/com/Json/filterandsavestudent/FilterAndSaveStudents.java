package com.Json.filterandsavestudent;
...
public class FilterAndSaveStudents {
    public static void main(String[] args) {
        try {
            ...
            File inputFile = new File("src/main/java/com/Json/filterandsavestudent/students_list.json");
            ...
            File outputFile = new File("src/main/java/com/Json/filterandsavestudent/students_age_gt_25.json");
