package com.Json.combinejsonfile;
...
public class MergeJSONFiles {
    public static void main(String[] args) {
        try {
            ...
            // 1️⃣ Read JSON files
            JsonNode json1 = mapper.readTree(new File("src/main/java/com/Json/combinejsonfile/student_part1.json"));
            JsonNode json2 = mapper.readTree(new File("src/main/java/com/Json/combinejsonfile/student_part2.json"));
            ...
            File mergedFile = new File("src/main/java/com/Json/combinejsonfile/student_merged.json");
